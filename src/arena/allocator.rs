...
use alloc::vec::Vec;
use crate::arena::{Arena, SegmentCache, SegmentMeta, SegmentId, KeyRange};
use crate::trie::{Node, Leaf};
...
mod tests {
    ...
    fn test_create_multiple_segments() {
        ...
        let segment1 = allocator.create_segment(KeyRange { start: 0, size: 1000 }, 0);
        let segment2 = allocator.create_segment(KeyRange { start: 2000, size: 3000 }, 1);
    ...
    fn test_get_segment_meta() {
        ...
        // Create segment
        let segment_id = allocator.create_segment(KeyRange { start: 5000, size: 1000 }, 2);
    ...
    fn test_get_segment_meta_mut() {
        ...
        // Create segment
        let segment_id = allocator.create_segment(KeyRange { start: 1000, size: 2000 }, 0);
    ...
    fn test_get_segment_cache() {
        ...
        // Create segment
        let segment_id = allocator.create_segment(KeyRange { start: 2000, size: 1000 }, 1);
    ...
    fn test_get_segment_cache_mut() {
        ...
        // Create segment
        let segment_id = allocator.create_segment(KeyRange { start: 3000, size: 2000 }, 0);
    ...
    fn test_get_leaf_arena() {
        ...
        // Create segment
        let segment_id = allocator.create_segment(KeyRange { start: 3000, size: 1000 }, 0);
        let meta = allocator.get_segment_meta(segment_id).unwrap();
        let arena_idx = meta.cache_key;
    ...
    fn test_get_leaf_arena_mut() {
        ...
        // Create segment and manually allocate arena
        let segment_id = allocator.create_segment(KeyRange { start: 4000, size: 500 }, 2);
        let meta = allocator.get_segment_meta(segment_id).unwrap();
        let arena_idx = meta.cache_key;
